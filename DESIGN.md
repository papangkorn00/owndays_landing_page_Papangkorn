...
### Brand & Accent
- **Action Blue** (`{colors.primary}` — #0066cc): The brand-level interactive color for text links and focus ring roots. Note: CTAs have been updated to be white by default (`#ffffff` with `#e0e0e0` border) and shift to a dark gray (`#666666`) on hover, rather than using Action Blue.
